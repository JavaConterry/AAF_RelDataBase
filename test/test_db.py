...
class DataBaseTest(unittest.TestCase):
    ...
    def test_btree_search_1level_eq_indexed_1(self):
        ...
        self.assertCountEqual(responce.data, [['Max Verstappen', '27'], ['Charles Leclerc', '27']])
    ...
    def test_btree_search_1level_eq_indexed_2(self):
        ...
        self.assertCountEqual(responce.data, [['Brazil','Verstappen'], ['Spain', 'Verstappen'],  ['Canada', 'Verstappen']])
    ...
    def test_btree_search_1level_eq_not_indexed(self):
        ...
        self.assertCountEqual(responce.data, [['Charles Leclerc', '27', 'Ferrari'],  ['Carlos Sainz', '30', 'Ferrari']])
    ...
    def test_btree_search_1level_uneq_indexed_1(self):
        ...
        db.do([['INSERT', 'table'], ['Lewis Hamilton', '39']])
        responce = db.do([['SELECT', 'table'], [ '>', 'age', '27']])
        self.assertCountEqual(responce.data, [ ['Pierre Gasly', '28'], ['Lewis Hamilton', '39']])
    ...
    def test_btree_search_1level_uneq_indexed_2(self):
        ...
        self.assertCountEqual(responce.data, [['Max Verstappen', '27'], ['Charles Leclerc', '27'],  ['Pierre Gasly', '28']])
    ...
    def test_btree_search_1level_uneq_indexed_3(self):
        ...
        self.assertCountEqual(responce.data, [['Charles Leclerc', '27'],  ['Lewis Hamilton', '39']])
    ...
    def test_select_2level_not_indexed_1(self):
        ...
        self.assertCountEqual(responce.data, [['Charles Leclerc', '27', 'Ferrari'],  ['Carlos Sainz', '30', 'Ferrari'], ['Lewis Hamilton', '39', 'Mercedes']])
    ...
    def test_select_2level_not_indexed_2(self):
        ...
        self.assertCountEqual(responce.data, [['Carlos Sainz', '30', 'Ferrari'], ['Lewis Hamilton', '39', 'Mercedes']])
    ...
    def test_select_3level_indexed_1(self):
        ...
        self.assertCountEqual(responce.data, [['Carlos Sainz', '30', 'Ferrari']])
    ...
    def test_select_3level_indexed_2(self):
        ...
        self.assertCountEqual(responce.data, [['Max Verstappen', '27', 'ORBR'],['Charles Leclerc', '27', 'Ferrari'],['Oscar Piastri', '23', 'McLaren'],['Lando Norris', '25', 'McLaren']])
    ...
    def test_search_in_single_column_indexed(self):
        ...
        self.assertCountEqual(responce.data, [['114', '24673']])
    ...
    def test_search_in_single_column_semiindexed_2(self):
        ...
        self.assertCountEqual(responce.data, [['4213', '114']])
